...
from rllava.model.patch.monkey_patch import is_transformers_version_in_range

# Import compatibility wrapper for flash_attn_supports_top_left_mask
from rllava.utils.transformers_compat import flash_attn_supports_top_left_mask
